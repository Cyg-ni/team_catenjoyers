...
export default function GeoRadiusRing({ coords, radiusMiles = 10 }) {
  ...
  return (
    <>
      ...
      >
        <Popup>
          <div style={{ fontFamily: 'system-ui, sans-serif', fontSize: 12, fontWeight: 700, color: '#2c3a14', padding: '2px 0' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 2 }}>
              <span style={{ display: 'inline-block', width: 8, height: 8, borderRadius: '50%', background: '#3b6d11', flexShrink: 0 }} />
              You are here
            </div>
